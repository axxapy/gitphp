 ...
 *  Component: Branchdiff view template
 *
...
{block name=main}
 ...
 <div class="page_nav">
   ...
   <br />
   {if $sidebyside}
   <a href="{geturl project=$project action=branchdiff branch=$branch branchparent=$branchparent diffmode=unified}">{t}unified{/t}</a>
   {else}
   <a href="{geturl project=$project action=branchdiff branch=$branch branchparent=$branchparent diffmode=sidebyside}">{t}side by side{/t}</a>
   {/if}
   | <a href="{geturl project=$project action=branchdiff branch=$branch branchparent=$branchparent output=plain}">{t}plain{/t}</a>
 </div>

 {include file='title.tpl' branch=$branch branchparent=$branchparent target='branchdiff' branches=$branch_list}
